	...
	<div class="container">
		<div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-6">
						<a href="office.php"><h2>Portofolio<b>IPN</b></h2></a>
					</div>
					...
					<div class="col-sm-6">
						...
						<a href="portofolio done.php" class="btn btn-success" ><i class="material-icons"></i> <span> Ajout un projet</span></a>
	...
	<tbody>
		...
		?>
					...
					<td><?php echo $row['text']; ?></td>
						...
						<td>  <div class="alb"><img src="projets/<?=$row['image_url']?>"></div></td>
					
							 
						
					<td><a class="btn btn-danger" href="portofolio delete.php?id=<?php echo $row['id']; ?>">Delete</a></td>
						<td><a class="btn btn-info" href="portofolio update.php?id=<?php echo $row['id']; ?>">Edit</a></td>
					</tr>	
