	...
	<div class="container">
		<div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-6">
						<a href="office.php"><h2>Gallery<b>IPN</b></h2></a>
					</div>
					...
					<div class="col-sm-6">
						...
						<a href="image done.php" class="btn btn-success" ><i class="material-icons"></i> <span> Ajout image</span></a>
	...
	<tbody>
		...
		?>
					...
					<td><?php echo $row['categorie']; ?></td>
						...
						<td>  <div class="alb"><img src="gallery/<?=$row['image_url']?>"></div></td>
					
							 
						
					<td><a class="btn btn-danger" href="image delete.php?id=<?php echo $row['id']; ?>">Delete</a></td>
						<td><a class="btn btn-info" href="image updat.php?id=<?php echo $row['id']; ?>">Edit</a></td>
					</tr>	
