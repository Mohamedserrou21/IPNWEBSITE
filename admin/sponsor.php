	...
	<div class="container">
		<div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-6">
						<a href="office.php"><h2>Sponsor<b>IPN</b></h2></a>
					</div>
					...
					<div class="col-sm-6">
						...
						<a href="sponsor done.php" class="btn btn-success" ><i class="material-icons"></i> <span> Ajout sponsor</span></a>
	...
	<tbody>
		...
		?>
					...
					<td><?php echo $row['sponsor_name']; ?></td>
						...
						<td>  <div class="alb"><img src="sponsor/<?=$row['image_url']?>"></div></td>
					
							 
						
					<td><a class="btn btn-danger" href="sponsor delete.php?id=<?php echo $row['id']; ?>">Delete</a></td>
						<td><a class="btn btn-info" href="sponsor update.php?id=<?php echo $row['id']; ?>">Edit</a></td>
					</tr>	
